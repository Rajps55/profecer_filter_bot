...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb://localhost:27017")  # Placeholder: MongoDB URL
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")  # Placeholder: MongoDB database का नाम
FILE_DB_URL = environ.get("FILE_DB_URL", DATABASE_URL)  # Placeholder: File database URL
FILE_DB_NAME = environ.get("FILE_DB_NAME", DATABASE_NAME)  # Placeholder: File database का नाम
